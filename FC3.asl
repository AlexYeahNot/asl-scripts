...

{
	...
	int trials : "FC3_d3d11.dll", 0x0135F77C, 0x268, 0x68, 0x18, 0x488, 0x48;
	int vehicle : "FC3_d3d11.dll", 0x005CCADC, 0x48, 0x50, 0x10, 0x28, 0x534;
	int finish : "FC3_d3d11.dll", 0x1E27808;
	double igt : "FC3_d3d11.dll", 0x01013AE8, 0xC, 0x30, 0x134, 0xC, 0x84, 0x20, 0x228;
}
